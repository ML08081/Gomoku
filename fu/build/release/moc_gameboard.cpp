...
QT_MOC_LITERAL(1, 10, 11), // "piecePlaced"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 1), // "x"
QT_MOC_LITERAL(4, 25, 1) // "y"

    },
    "GameBoard\0piecePlaced\0\0x\0y"
};
...
void GameBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->piecePlaced((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameBoard::piecePlaced)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameBoard::piecePlaced(int _t1, int _t2)
{
